...
\begin{frame}{Summary}
	\textbf{Julia}
	\begin{itemize}
		\item is a dynamic language (Julia is easy to use) while having the advantages of static languages (Julia is fast)
		...
		\item can call other languages
		\item is made for researchers (but it can do much more)
		\item comes with many more smart and useful design choices
	\end{itemize}
\end{frame}
