...
\begin{frame}[fragile]{Broadcasting}
  ...
  \end{Boxx}
	...
	\pause
	%~ \vspace*{-0.15cm}
	\fbox{\parbox{\linewidth}{\textbf{\color{red} Create a vector ``v'' of dim = 2 (e.g. elements (1, 2)) and add it to the matrix ``m'' of dim = 2x2}}}
	\pause
  \begin{Boxx}
  \begin{jllisting}
	v = [1, 2]
...
\end{Boxx}		
	...
	\centering \includegraphics[width=0.5\linewidth]{images_data/plot_final}
