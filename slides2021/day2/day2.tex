...
\author[Juan Polo]{Juan Polo {\tiny $\Bigg\{$ \parbox{2cm}{\centering material taken/based on Ankur Dhar \& James Schloss}$\Bigg\}$}} % Your name
\institute[OIST] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
	\textit{juan.polo@oist.jp} \\ % Your institution for the title page
	\textit{\tiny ankurd@oist.jp} \\ % Your institution for the title page
	\textit{\tiny james.schloss@oist.jp} % Your email address
}
\date{\vspace*{-0.5cm}\\ February 24th, 2021} % Date, can be changed to a custom date
...
\begin{frame}[fragile]{Broadcasting}
	It is sometimes useful to perform element-by-element binary operations on arrays of different sizes. Dotted operators such as \verb|.+| and \verb|.*| are equivalent to broadcast calls
  ...
  \end{Boxx}
	...
	\pause
	%~ \vspace*{-0.15cm}
	\fbox{\parbox{\linewidth}{\textbf{\color{red} Create a vector of dim = 2 (e.g. elements (1, 2)) and add it to m of dim = 2x2}}}
	\pause
  \begin{Boxx}
  \begin{jllisting}
	v = [1, 2]
